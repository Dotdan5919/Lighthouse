...
const Cart = () => {
  return (
    <div className="item lg:grid grid grid-cols-10 lg:grid-rows-none grid-rows-1  lg:grid-cols-11   p-7 lg:gap-20  ">
            ...
            <div className="flex col-span-4 lg:col-start-3 col-start-5 flex-col gap-3">   
            ...
            <div className="nav flex gap-2 items-center justify-center text-lg lg:bg-current  bg-gray-100 rounded-lg col-start-7 row-start-2 lg:row-start-auto lg:col-start-auto ">
            ...
            <h1 className="price font-bold lg:col-start-9 lg:row-start-auto row-start-2 col-start-5 self-center ">$399</h1>
